...
public class Modulo<T1, T2> extends BinaryExpression<T1, T2, Number> implements NumericExpression<Object> {
  public Modulo(Expression<T1, Number> left, Expression<T2, Number> right) {
    super(left, right);
  }
